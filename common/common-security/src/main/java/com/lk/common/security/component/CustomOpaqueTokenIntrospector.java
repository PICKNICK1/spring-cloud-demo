...
import com.lk.common.security.service.UserDetailsService;
...
public class CustomOpaqueTokenIntrospector implements OpaqueTokenIntrospector {
    ...
    public OAuth2AuthenticatedPrincipal introspect(String token) {
        ...
        if (AuthorizationGrantType.CLIENT_CREDENTIALS.equals(oldAuthorization.getAuthorizationGrantType())) {
            return new CustomClientCredentialsOAuth2AuthenticatedPrincipal(oldAuthorization.getAttributes(),
        ...
        try {
            ...
            userDetails = optional.get().loadUserByUser((User) tokenPrincipal);
